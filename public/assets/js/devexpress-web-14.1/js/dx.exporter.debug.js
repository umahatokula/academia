        ...
        var dxMenuBase = ui.CollectionWidget.inherit({
                ...
                _supportedKeys: function() {
                    var selectItem = function(e) {
                            var $item = this.option("focusedItem");
                ...
                _render: function() {
                    ...
                    this._isDesktopDevice() && this._attachItemMouseEvents()
                },
                ...
                _attachItemMouseEvents: function() {
                    var itemSelector = this._itemWrapperSelector(),
                        mouseEnterEventName = events.addNamespace('dxhoverstart', this.NAME),
                        mouseLeaveEventName = events.addNamespace('dxhoverend', this.NAME),
                ...
                _itemMouseEnterHandler: function(e) {
                    ...
                    if ($itemElement) {
                        ...
                        e.stopPropagation();
                        isItemDisabled ? this.option("focusedItem", null) : this.option("focusedItem", $itemElement);
                ...
                _getItemElementByEventArgs: function(eventArgs) {
                    ...
                    while (!$target.hasClass(this._itemClass())) {
                        ...
                        if ($target.hasClass("dx-submenu") || $target.get(0) === currentTarget)
                            return null
                    }
                    return $target
                },
        ...
        DX.registerComponent("dxContextMenu", ui, ui.dxMenuBase.inherit({
            ...
            _moveFocus: function(location) {
                var $items = this._getItemsByLocation(location),
                    ...
                    $newTarget,
                    $focusedItem = this.option("focusedItem");
                switch (location) {
                    case FOCUS_UP:
                ...
                if ($newTarget.length !== 0)
                    this.option("focusedItem", $newTarget)
            },
                ...
                var that = this,
                    ...
                    holdAction = this._createAction($.proxy(function(e) {
                        if (!that.option('invokeOnlyFromCode'))
                            !events.isMouseEvent(e.jQueryEvent) && that._show(e.jQueryEvent)
                    }, this)),
                    contextMenuAction = this._createAction($.proxy(function(e) {
                        var promise;
                        if (!that.option('invokeOnlyFromCode')) {
                            promise = that._show(e.jQueryEvent);
            ...
            _show: function(jQEvent) {
                ...
                if (canShowMenu && this._overlay) {
                    this.option("focusedItem", this._itemElements().first());
    ...
    (function($, DX, undefined) {
        ...
        DX.registerComponent("dxMenu", ui, ui.dxMenuBase.inherit({
            ...
            _moveMainMenuFocus: function(direction) {
                ...
                this.focus();
                this.option("focusedItem", $newItem)
            },
            ...
            _itemMouseEnterHandler: function(e) {
                ...
                if (showFirstSubmenuMode !== 'onClick' && submenu && !isSelectionActive) {
                    ...
                    if (isHoverStayMode && !submenu._overlay.option('visible')) {
                        $item.off(mouseMoveEventName).on(mouseMoveEventName, $.proxy(this._itemMouseMoveHandler, this));
            ...
            _hideShownSubmenuOnOptionChange: function(optionName) {
                if (optionName !== "focusedItem" && this._visibleSubmenu.length)
                    this._hideSubmenu(this._visibleSubmenu)
            },
