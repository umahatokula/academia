          ...
          <div class="panel panel-default">
            ...
            @if (count($errors) > 0)
              ...
              <!-- <form role="form" class="form-horizontal" role="form"> -->
               {!! Form::open(array('route' => 'admin.parents.store', 'class' => 'form-horizontal', 'role' => 'form', 'files' => true)) !!}
                ...
                <div class="form-group {{ $errors->has('gender_id')? 'has-error' : ''}}">
                  ...
                  <div class="col-sm-10">
                  {!! Form::select('gender_id', $gender, null, array('class' => 'form-control', 'id' => 'gender_id')) !!}
                  </div>
                </div>
                ...
                <div class="form-group {{ $errors->has('country_id')? 'has-error' : ''}}">
                  ...
                  <div class="col-sm-10">
                  {!! Form::select('country_id', $countries, '566', array('class' => 'form-control', 'id' => 'country_id')) !!}
                  </div>
                </div>
                ...
                <div class="form-group {{ $errors->has('local_id')? 'has-error' : ''}}">
                  ...
                  <div class="col-sm-10">
                  {!! Form::select('local_id', $locals, null, array('class' => 'form-control', 'id' => 'local_id')) !!}
                  </div>
                </div>
                ...
                <div class="form-group {{ $errors->has('blood_group_id')? 'has-error' : ''}}">
                  ...
                  <div class="col-sm-10">
                  {!! Form::select('blood_group_id', $bloodGroups, null, array('class' => 'form-control', 'id' => 'blood_group_id')) !!}
                  </div>
                </div>
                ...
                <div class="form-group {{ $errors->has('religion_id')? 'has-error' : ''}}">
                  ...
                  <div class="col-sm-10">
                  {!! Form::select('religion_id', $religions, null, array('class' => 'form-control', 'id' => 'religion_id')) !!}
                  </div>
                </div>
                ...
                <div class="form-group {{ $errors->has('religion_id')? 'has-error' : ''}}">
                  ...
                  <div class="col-sm-10">
                  {!! Form::select('staff', [''=>'Please select', '1'=>'Yes', '0'=>'No'], null, array('class' => 'form-control', 'id' => 'staff')) !!}
                  </div>
                </div>
                ...
                <div class="form-group">
                  ...
                  <div class="col-sm-10">
                  {!! Form::submit('add parent', array('class' => 'btn btn-blue')) !!}
                  </div>
                </div>
