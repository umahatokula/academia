          ...
          <div class="panel panel-default">
            ...
            @if (count($errors) > 0)
              ...
              <!-- <form role="form" class="form-horizontal" role="form"> -->
               {!! Form::open(array('route' => 'admin.students.store', 'class' => 'form-horizontal', 'role' => 'form', 'files' => true)) !!}
                ...
                <div class="form-group {{ $errors->has('country_id')? 'has-error' : ''}}">
                  ...
                  <div class="col-sm-10">
                  {!! Form::select('country_id', $countries, '566', array('class' => 'form-control', 'id' => 'country_id', 'required')) !!}
                  </div>
                </div>
                ...
                <div class="form-group">
                  ...
                  <div class="col-sm-10">
                  {!! Form::submit('add student', array('class' => 'btn btn-blue')) !!}
                  </div>
                </div>
