...
<div class="row">
        <div class="col-sm-12">
          ...
          <div class="panel panel-default">
            ...
            <center>
              <div>
              {!! Form::open(array('route' => 'fetchSheet',  'class' => 'form-inline', 'role' => 'form')) !!}
                <div class="form-group">
                  {!! Form::select('class', $classes, null, array('class' => 'form-control', 'id' => 'class')) !!}
                </div>
...
<script>
  $('#class').on('change', function(e){
      ...
      form.attr('action', 'academics/result/' + select.val());
      form.submit();
  });
</script>
