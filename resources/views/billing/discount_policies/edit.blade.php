          ...
          <div class="panel panel-default">
            ...
            @if (count($errors) > 0)
              ...
              <!-- <form role="form" class="form-horizontal" role="form"> -->
               {!! Form::model($fee_element, array('route' => array('billing.fee_elements.update', $fee_element->id), 'method' => 'PUT', 'class' => 'form-horizontal', 'role' => 'form')) !!}
                ...
                <div class="form-group">
                  ...
                  <div class="col-sm-10">
                  {!! Form::submit('edit fee element', array('class' => 'btn btn-blue')) !!}
                  </div>
                </div>
