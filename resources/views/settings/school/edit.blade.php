          ...
          <div class="panel panel-default">
            ...
            @if (count($errors) > 0)
              ...
              <!-- <form role="form" class="form-horizontal" role="form"> -->
               {!! Form::model($subject, array('route' => array('settings.subjects.update', $subject->id), 'method' => 'PUT', 'class' => 'form-horizontal', 'role' => 'form')) !!}
      
                <div class="form-group {{ $errors->has('subject')? 'has-error' : ''}}">
                  <!-- <label class="col-sm-2 control-label" for="field-1">Input text field</label> -->
                  {!! Form::label('subject', 'Subject', array('class' => 'col-sm-4 control-label', 'for' => 'subject')) !!}
                ...
                <div class="form-group">
                  ...
                  <div class="col-sm-10">
                  {!! Form::submit('add subject', array('class' => 'btn btn-blue')) !!}
                  </div>
                </div>
